...
export const checklistPhases: ChecklistPhase[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        id: "d14-apps",
        label: "安裝高德地圖、12306 或 Trip.com；需要時安裝大眾點評／美團",
        priority: "recommend",
      },
      {
        id: "d14-verify",
...
export const appItems: AppItem[] = [
  ...
  },
  {
    ...
    alt: "Google Maps 在中國大陸資料與定位常不準，別當唯一導航。",
  },
  {
    id: "didi",
    category: "叫車",
...
export const faqs: Faq[] = [
  ...
  },
  {
    id: "faq-cash",
    q: "現金要帶多少？",
    a: "行動支付是主流，但仍建議留實體備援。一般短程可先備人民幣 300–500 元，偏遠地區、長天數或不熟行動支付者再自行提高，這不是固定標準答案。",
  },
  {
    id: "faq-both",
    q: "支付寶和微信兩個都要裝嗎？",
    a: "建議都裝。支付寶與微信支付雙主力，兩者都在出發前鉅細靡遺實名認證，再加一張備援卡與少量現金當做實體備援。",
  },
  {
    id: "faq-hotel",
    q: "飯店怎麼確認可以用臺胞證入住？",
    a: "去年起全國已全面取消涉外飯店資質限制，所有旅宿大體上都能接待所有旅客。但少數旅宿可能仍有設備不足或法規熟悉度不夠的問題，非到必要不用過度擔心身份問題，若有疑慮訂房前簡單確認即可。",
  },
  {
    id: "faq-rail",
    q: "高鐵要用哪個 App 買票？",
  ...
  {
    id: "faq-google",
    q: "Google 和 LINE 在那邊能用嗎？",
    a: "在中國大陸網路環境下，Google 系服務與部分通訊軟體常無法直接連線。若重視這些服務，選擇免翻牆 eSIM／SIM 方案較方便，並以高德地圖作為主要導航。",
  },
];

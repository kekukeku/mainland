    ...
    <section className="section section-alt" id="vpn" aria-labelledby="vpn-title">
      <div className="container">
        <div className="section-head">
          <span className="section-eyebrow">科學上網最推薦指南</span>
          <h2 className="section-title" id="vpn-title">
            VPN
          </h2>
          <p className="section-lead">
            免翻牆卡片外的另一種方案：若你打算申辦大陸的 SIM 卡和使用當地 WiFi，這篇指南能帶你搞懂所有翻牆技巧。
          </p>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          ...
          <article className="card" style={{ borderTop: "4px solid var(--color-primary)", padding: "2rem", boxShadow: "var(--shadow-md)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "2.5rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                  ...
                  <div style={{ display: "flex", gap: "0.75rem", alignItems: "flex-start" }}>
                    ...
                    <div>
                      ...
                      <span style={{ fontSize: "0.9rem", color: "var(--color-text-secondary)", display: "block" }}>
                      ...
                      <span style={{ fontSize: "0.8rem", color: "var(--color-text-secondary)", display: "block", marginTop: "0.35rem", opacity: 0.8 }}>
                        *任何 app 都能搭配任何一家供應商
                      </span>
                    </div>
                  </div>
              ...
              <div>
                ...
                <p className="check-note" style={{ fontSize: "0.95rem", lineHeight: "1.5", marginBottom: "1.25rem" }}>
                  有時俗稱「機場」，任選應用層 app 都能載入其訂閱節點，付費後就能拿到訂閱連結/QR code，用 app 一鍵導入。
                </p>
                
                <ul style={{ margin: 0, paddingLeft: "1.25rem", listStyleType: "circle", display: "flex", flexDirection: "column", gap: "0.75rem", fontSize: "0.95rem" }}>
                  <li>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.5rem" }}>
            ...
            <article className="card" style={{ borderTop: "2px solid var(--color-secondary)", padding: "1.25rem" }}>
              ...
              <p className="check-note" style={{ fontSize: "0.9rem" }}>
            ...
            <article className="card" style={{ borderTop: "2px solid var(--color-text-secondary)", padding: "1.25rem" }}>
              ...
              <p className="check-note" style={{ fontSize: "0.9rem", marginBottom: "0.5rem" }}>
                一鍵安裝、開關即用。在大陸 GFW 封鎖下表現起伏較大，費用較高，但適合懶得動手設定訂閱的旅人。
              </p>
              <ul style={{ margin: 0, paddingLeft: "1.25rem", listStyleType: "circle", display: "flex", flexDirection: "column", gap: "0.25rem", fontSize: "0.85rem", color: "var(--color-text-secondary)" }}>
                <li>
